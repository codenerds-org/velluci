        ...
        <footer className="flex flex-col items-center justify-center bg-black text-white py-12">
            <div className="flex flex-row items-center justify-center gap-8">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm">
                        <a href="https://www.instagram.com/velluci_official/">
                            Instagram
                        </a>
                    </p>
                </div>
            </div>
            <p className="text-sm mt-8">© {new Date().getFullYear()} Velluci. All rights reserved.</p>
            <p className="text-sm">Designed by <a href="https://codenerds.tech">Code Nerds</a></p>
        </footer>
    )
}
